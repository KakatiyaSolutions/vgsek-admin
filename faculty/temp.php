...
<form action="temp.php" method="GET" enctype="multipart/form-data" class="searchform" onsubmit="return validateSearch()">
...
<div class="pagination">
        ...
        <?php for ($i = 1; $i <= $totalPages; $i++): ?>
            <a href="temp.php?page=<?php echo $i; ?>&items_per_page=<?php echo $itemsPerPage; ?>" <?php if ($i == $page) echo 'class="active"'; ?>>
                <?php echo $i; ?>
            </a>
        <?php endfor; ?>

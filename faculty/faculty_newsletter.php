...
$query = "SELECT sno, department,department_name, description, status
          FROM dep_faculty_newsletter WHERE department_name = ?";
...
<div class="main-content">
            ...
            <h1>Update Faculty News-letter Department Details of <?php echo htmlspecialchars($department_name); ?></h1>
             <form action="update_faculty_newsletter.php?department=<?php echo urlencode($department_name); ?>" method="POST">

...
// $department_query = "SELECT DISTINCT department FROM dep_faculty_publications2";
...
$query = "SELECT sno, title, department, department_name, description, status
          FROM dep_faculty_publications2 WHERE department_name LIKE ?";
...
<div class="main-content">
 ...
 <!-- Department Selection Dropdown -->
        ...
        <?php foreach ($forms as $index => $form) : ?>
            <form action="update_faculty_publications.php?department=<?php echo urlencode($form['department_name']); ?>" method="POST">
...
function toggleEditor(editorId) {
    ...
    // function addNewRow() {
    //     const newRowForm = `
    //         <form class="new-row-form" id="new-row-form" action="update_faculty_publications.php?department=<?php echo urlencode($department); ?>" method="POST">
    ...
    //     xhr.open('POST', 'update_faculty_publications.php?department=' + department, true);

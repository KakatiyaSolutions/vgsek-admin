...
$area_in_sqm = preg_replace('/<figure[^>]*>|<\/figure>/', '', $area_in_sqm);
...
$area_in_sqm = add_table_classes($area_in_sqm);
...
$area_in_sqm = mysqli_real_escape_string($con, $area_in_sqm);

...
$query = "SELECT id, branch_name, lab_name, configuration_details, area_in_sqm, number_of_systems, lab_details, lab_image, 	laboratories, syllabus, timetable, academic_calendar FROM dep_btech WHERE branch_name = ?";
...
$id= $branch_name= $lab_name= $configuration_details= $area_in_sqm= $number_of_systems = $lab_details= $lab_image= $laboratories = $syllabus= $timetable= $academic_calendar = "";
...
$configuration_details= htmlspecialchars_decode($row['configuration_details']);
$area_in_sqm = htmlspecialchars_decode($row['area_in_sqm']);
$number_of_systems = htmlspecialchars_decode($row['number_of_systems']);
$lab_details = htmlspecialchars_decode($row['lab_details']);
$lab_image = htmlspecialchars_decode($row['lab_image']);
$laboratories = htmlspecialchars_decode($row['laboratories']);
$syllabus = htmlspecialchars_decode($row['syllabus']);
$timetable = htmlspecialchars_decode($row['timetable']);
$academic_calendar = htmlspecialchars_decode($row['academic_calendar']);
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['selected_lab']))
   
    $selected_lab = $_POST['selected_lab'];

    // Fetch lab details for the selected lab
    $con = mysqli_connect('srv1328.hstgr.io', 'u629694569_vcpkacin_web', 'Kakatiya@1243', 'u629694569_vcpkacin_web');
    if (!$con) {
        die("Connection failed: " . mysqli_connect_error());
    }
    ...
    if ($result->num_rows > 0) {
        ...
        echo "<p>No details found for the selected lab.</p>";
    }
...
<div id="app">
    ...
    <?php
    // Fetch labs dynamically for the dropdown
    $con = mysqli_connect('srv1328.hstgr.io', 'u629694569_vcpkacin_web', 'Kakatiya@1243', 'u629694569_vcpkacin_web');
    if (!$con) {
        die("Connection failed: " . mysqli_connect_error());
    }
    ...
    // Fetch the selected lab name from POST (if available)
    $selectedLab = isset($_POST['selected_lab']) ? $_POST['selected_lab'] : '';

    while ($row = $result->fetch_assoc()) {
        $lab = $row['lab_name'];
        $isSelected = ($lab === $selectedLab) ? 'selected' : ''; // Mark selected option
        echo "<option value='" . htmlspecialchars($lab) . "' $isSelected>" . htmlspecialchars($lab) . "</option>";
    }
    ...
    <!-- Update Form -->
        ...
        <textarea name="id" id="id"><?php echo $id; ?></textarea><br><br>
            ...
            <label for="lab_name">Lab Name:</label><br>
            <textarea name="lab_name" id="lab_name"><?php echo $lab_name; ?></textarea><br><br>

            <label for="configuration_details">Configuration Details:</label><br>
            <textarea name="configuration_details" id="configuration_details"><?php echo $configuration_details; ?></textarea><br><br>

            <label for="area_in_sqm">Area in Sqm:</label><br>
            <textarea name="area_in_sqm" id="area_in_sqm"><?php echo $area_in_sqm; ?></textarea><br><br>

            <label for="number_of_systems">Number of Systems:</label><br>
            <textarea name="number_of_systems" id="number_of_systems"><?php echo $number_of_systems; ?></textarea><br><br>

            <label for="lab_details">Lab Details:</label><br>
            <textarea name="lab_details" id="lab_details"><?php echo $lab_details; ?></textarea><br><br>

            <label for="lab_image">Lab Image:</label><br>
            <textarea name="lab_image" id="lab_image"><?php echo $lab_image; ?></textarea><br><br>

            <label for="laboratories">Laboratories:</label><br>
            <textarea name="laboratories" id="laboratories"><?php echo $laboratories; ?></textarea><br><br>

            <label for="syllabus">Syllabus:</label><br>
            <textarea name="syllabus" id="syllabus"><?php echo $syllabus; ?></textarea><br><br>

            <label for="timetable">Timetable:</label><br>
            <textarea name="timetable" id="timetable"><?php echo $timetable; ?></textarea><br><br>

            <label for="academic_calendar">Academic Calendar:</label><br>
            <textarea name="academic_calendar" id="academic_calendar"><?php echo $academic_calendar; ?></textarea><br><br>
    ...
    <label for="lab_name">lab_name:</label><br>
        <textarea name="lab_name" id="lab_name"><?php echo $lab_name; ?></textarea><br><br>

        <label for="configuration_details">configuration_details:</label><br>
        <textarea name="configuration_details" id="configuration_details"><?php echo $configuration_details; ?></textarea><br><br>

        <label for="area_in_sqm">area_in_sqm:</label><br>
        <textarea name="area_in_sqm" id="area_in_sqm"><?php echo $area_in_sqm; ?></textarea><br><br>

        <label for="number_of_systems">number_of_systems:</label><br>
        <textarea name="number_of_systems" id="number_of_systems"><?php echo $number_of_systems; ?></textarea><br><br>

        <label for="lab_details">lab_details:</label><br>
        <textarea name="lab_details" id="lab_details"><?php echo $lab_details; ?></textarea><br><br>

        <label for="lab_image">lab_image:</label><br>
        <textarea name="lab_image" id="lab_image"><?php echo $lab_image; ?></textarea><br><br>
        ...
        <label for="academic_calendar">academic_calendar:</label><br>
        <textarea name="academic_calendar" id="academic_calendar"><?php echo $academic_calendar; ?></textarea><br><br>

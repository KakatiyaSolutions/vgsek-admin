...
$department = isset($_GET['department']) ? $_GET['department'] : 'EEE'; // Default to 'CSE'

// Fetch data for the selected department
$query = "SELECT sno, department,department_name, description, status
          FROM student_results WHERE department_name = ?";
...
<div class="main-content">
            ...
            <h1>Update Student Results Department Details of <?php echo htmlspecialchars($department_name); ?></h1>
             <form action="update_student_results.php?department=<?php echo urlencode($department_name); ?>" method="POST">

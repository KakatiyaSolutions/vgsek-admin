...
// $department_query = "SELECT DISTINCT department FROM student_events2";
...
$query = "SELECT sno, title, department, department_name, description, status
          FROM student_events2 WHERE department_name LIKE ?";
...
<div class="main-content">
 ...
 <!-- Department Selection Dropdown -->
        ...
        <?php foreach ($forms as $index => $form) : ?>
            <form action="update_student_events.php?department=<?php echo urlencode($form['department_name']); ?>" method="POST">
...
function toggleEditor(editorId) {
    ...
    // function addNewRow() {
    //     const newRowForm = `
    //         <form class="new-row-form" id="new-row-form" action="update_student_events.php?department=<?php echo urlencode($department); ?>" method="POST">
    ...
    //     xhr.open('POST', 'update_student_events.php?department=' + department, true);

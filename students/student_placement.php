...
$query = "SELECT sno, po, department,department_name, description, status, vision, mission, peo, po_pso,  advisory_board , achivements, board_of_studies
          FROM student_placements WHERE department_name = ?";
...
<div class="main-content">
            ...
            <h1>Update Student Placement Department Details of <?php echo htmlspecialchars($department_name); ?></h1>
             <form action="update_student_placement.php?department=<?php echo urlencode($department_name); ?>" method="POST">
